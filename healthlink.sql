...
--
-- Host: 127.0.0.1    Database: healthlink
-- ------------------------------------------------------
...
INSERT INTO `assigned_to` VALUES (1,1,1),(2,2,2),(3,3,3),(4,4,4),(5,5,5),(6,6,6),(7,7,7),(8,8,8),(9,9,9),(10,10,10);
...
INSERT INTO `doctor` VALUES (1,'(408) 555-2001','Michael','Chen'),(2,'(408) 555-2002','Sarah','Williams'),(3,'(408) 555-2003','David','Patel'),(4,'(408) 555-2004','Emily','Nguyen'),(5,'(408) 555-2005','James','Rodriguez'),(6,'(408) 555-2006','Jessica','Kim'),(7,'(408) 555-2007','Robert','Wilson'),(8,'(408) 555-2008','Olivia','Martinez'),(9,'(408) 555-2009','Daniel','Thompson'),(10,'(408) 555-2010','Sophia','Garcia');
...
INSERT INTO `medication_log` VALUES (1,1,1,'2025-07-07 09:00:00','10mg','2025-07-07','Taken as prescribed.'),(2,2,2,'2025-07-07 08:30:00','500mg','2025-07-07','Taken with breakfast.'),(3,3,3,'2025-07-06 21:00:00','20mg','2025-07-06','Taken before bed.'),(4,4,4,'2025-07-07 10:00:00','250mg','2025-07-07','Completed full course.'),(5,5,5,'2025-07-07 07:00:00','75mcg','2025-07-07','Taken on an empty stomach.'),(6,6,6,'2025-07-07 08:00:00','20mg','2025-07-07','Taken before first meal.'),(7,7,7,'2025-07-07 09:30:00','50mg','2025-07-07','No side effects reported.'),(8,8,8,'2025-07-07 18:00:00','5mg','2025-07-07','INR check scheduled next week.'),(9,9,9,'2025-07-07 14:15:00','2 puffs','2025-07-07','Used during mild exertion.'),(10,10,10,'2025-07-07 08:45:00','25mg','2025-07-07','Reduced swelling.');
...
INSERT INTO `patient` VALUES (1,'1990-05-15','(408) 555-1234','123 Main St, San Jose, CA 95112','Jane Liu','(408) 555-1235'),(2,'1985-11-22','(408) 555-2345','456 Oak Ave, Santa Clara, CA 95050','Ali Hasham','(408) 555-2346'),(3,'1992-07-01','(408) 555-3456','789 Pine Ln, Milpitas, CA 95035','Omar Hasan','(408) 555-3457'),(4,'1978-03-20','(408) 555-4567','101 Elm Rd, Sunnyvale, CA 94087','John Madden','(408) 555-4568'),(5,'1965-09-10','(408) 555-5678','202 Birch Ct, Cupertino, CA 95014','Robert Sanders','(408) 555-5679'),(6,'1995-01-25','(408) 555-6789','303 Cedar Dr, Campbell, CA 95008','Maria Shaffer','(408) 555-6790'),(7,'1980-04-03','(408) 555-7890','404 Dogwood Pl, Los Gatos, CA 95032','Sarah Stubbs','(408) 555-7891'),(8,'1972-12-18','(408) 555-8901','505 Fir St, Saratoga, CA 95070','Lisa Louis','(408) 555-8902'),(9,'2000-06-08','(408) 555-9012','606 Spruce Way, Mountain View, CA 94043','Robert Smith','(408) 555-9013'),(10,'1975-08-01','(408) 555-1111','808 Maple Ave, San Jose, CA 95123','Susan Davis','(408) 555-1112');
...
CREATE TABLE `test_result` (
  ...
  `test_type` enum('image','pdf') DEFAULT NULL,
...
INSERT INTO `test_result` VALUES (1,1,11,'patient1/blood_work_20250701.pdf','pdf','2025-07-01 10:30:00'),(2,2,12,'patient2/xray_chest_20250628.jpg','image','2025-06-28 15:45:00'),(3,3,13,'patient3/mri_brain_20250703.dcm','image','2025-07-03 11:00:00'),(4,4,14,'patient4/urine_analysis_20250702.pdf','pdf','2025-07-02 09:15:00'),(5,5,15,'patient5/ecg_20250629.pdf','pdf','2025-06-29 13:20:00'),(6,6,16,'patient6/ct_abdomen_20250704.dcm','image','2025-07-04 16:00:00'),(7,7,17,'patient7/thyroid_panel_20250701.pdf','pdf','2025-07-01 11:40:00'),(8,8,18,'patient8/ultrasound_20250705.jpg','image','2025-07-05 09:55:00'),(9,9,19,'patient9/allergy_test_20250630.pdf','pdf','2025-06-30 14:00:00'),(10,10,20,'patient10/colonoscopy_report_20250706.pdf','pdf','2025-07-06 10:10:00');
...
CREATE TABLE `user` (
  ...
  `password_hashed` varchar(45) DEFAULT NULL,
  `first_name` varchar(45) DEFAULT NULL,
  `last_name` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2025-07-08  9:13:40
