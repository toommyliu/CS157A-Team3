...
<html>
  ...
  <div class="d-flex justify-content-center align-items-center vh-100 px-5">
    <div class="row w-100 h-100 justify-content-center align-items-center g-2">
        ...
        <div class="d-flex align-items-center px-3 px-lg-4 mt-2">
          ...
          >
            ...
            <div class="d-flex flex-column gap-2">
              ...
              <select class="form-select w-25" id="role" name="role" required>
            ...
            <p>
              ...
              <a href="<%= request.getContextPath() %>/" class="link-info">Login</a>
            </p>
          </form>
        </div>
      </div>
