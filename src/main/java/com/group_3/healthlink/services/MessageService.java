...
public class MessageService {
     ...
     * @param userRole the role of the user (Patient or Doctor)
     * @return a list of User objects representing chat threads
     *         (doctors for patients, patients for doctors)
     */
    public static List<User> getChatThreads(int userId, UserRole userRole) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                // Convert database role to enum (capitalize first letter for display purposes)
                if (roleStr != null) {
     ...
     * @param user1Id the ID of the first user
     * @param user2Id the ID of the second user
     * @return the latest Message object between the two users, or null if no
     *         messages found
     */
     ...
     *
     * @param userId      the ID of the user
     * @param otherUserId the ID of the other user in the chat thread
     * @return the count of unread messages in the chat thread
     */
     ...
     *
     * @param userId the ID of the user
     * @return the count of unique conversations with unread messages
     */
